...
import org.wickedsource.wickedforms.wicket6.components.PatternAttributeModifier;
 ...
 * text field.
 * <li><strong>inputField</strong>: a {@link org.apache.wicket.markup.html.form.TextField} that takes the user's
 * input.
 * </ul>
 * 
...
public class TextFieldPanel<T> extends AbstractInputFieldPanel<T> {
	...
	private final org.apache.wicket.markup.html.form.TextField textField;

	public TextFieldPanel(final String id, final TextField<T> model, final Class<T> modelClass) {
		super(id, model);

		this.textField = new org.apache.wicket.markup.html.form.TextField("inputField", new PropertyModel<T>(model, "value"), modelClass);
