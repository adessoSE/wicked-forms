 ...
 */
public abstract class AbstractSingleChoice<T> extends
    AbstractInputField<T> {
	 ...
	 *            the choices.
	 */
	public AbstractSingleChoice(final String label, final List<T> choices, final ChoiceLabeller<T> choiceLabeller,
			Class<T> modelClass) {
		super(label);
	 ...
	 * 
	 */
	public AbstractSingleChoice(final String label, final List<T> choices, Class<T> modelClass) {
		super(label);
		this.choices = choices;
		this.modelClass = modelClass;
	...
	public AbstractSingleChoice(final List<T> choices, final ChoiceLabeller<T> choiceLabeller, Class<T> modelClass) {
		this.choices = choices;
		this.choiceLabeller = choiceLabeller;
		this.modelClass = modelClass;
	}
